        ...
        <div class="row row-offcanvas row-offcanvas-right active">
            <div class="horizontal-slider clearfix" style="width: 100%">
                <div
                    ...
                    <ul class="list-group">
                        <li class="list-group-item active" aria-current="true">Wilayah DAS {{ $detail->nama }}</li>
                        @foreach ($data as $item)
                            <a href="/fordas_list_laporan/{{ $item->id }}"><li class="list-group-item">{{ $item->nama }}</li></a>                        
                        @endforeach
                    </ul>
                </div>
